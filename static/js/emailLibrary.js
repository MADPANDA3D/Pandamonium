...
export function openEmailLibrary(opts = {}) {
        ...
        <div class="admin-card" style="flex:1;flex-direction:column;display:flex;overflow:hidden;">
          ...
          <div class="memory-toolbar">
            <div class="memory-category-filters">
              ...
              <button class="memory-toolbar-btn email-reminders-clear-btn hidden" id="email-reminders-clear-btn">
            ...
            <div class="email-search-wrap" style="position:relative;flex:1;min-width:140px;">
              ...
              <button class="memory-toolbar-btn email-reminder-toggle-inline hidden" id="email-reminder-btn">
  ...
  modal.querySelector('#email-reminders-clear-btn').title = `Permanently delete ${getBrandName()} reminder emails`;
  modal.querySelector('#email-reminder-btn').title = `Show ${getBrandName()} reminder emails`;
  ...
  document.getElementById('email-reminders-clear-btn')?.addEventListener('click', async () => {
    const ok = await styledConfirm(`Permanently delete all ${getBrandName()} reminder emails?`, {
      confirmText: 'Delete',
      cancelText: 'Cancel',
      danger: true,
    });
