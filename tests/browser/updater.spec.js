...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v395', 'pandamonium-v396');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v396';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v395';
  const targetCache = bridgeReload ? 'pandamonium-v395' : 'pandamonium-v396';
