...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v396', 'pandamonium-v397');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v397';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v396';
  const targetCache = bridgeReload ? 'pandamonium-v396' : 'pandamonium-v397';
