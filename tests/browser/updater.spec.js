...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v401', 'pandamonium-v402');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v402';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v401';
  const targetCache = bridgeReload ? 'pandamonium-v401' : 'pandamonium-v402';
