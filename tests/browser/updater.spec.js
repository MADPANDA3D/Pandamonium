...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v394', 'pandamonium-v395');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v395';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v394';
  const targetCache = bridgeReload ? 'pandamonium-v394' : 'pandamonium-v395';
