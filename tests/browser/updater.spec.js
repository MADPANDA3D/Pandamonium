...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v393', 'pandamonium-v394');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v394';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v393';
  const targetCache = bridgeReload ? 'pandamonium-v393' : 'pandamonium-v394';
