...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v421', 'pandamonium-v422');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v422';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v421';
  const targetCache = bridgeReload ? 'pandamonium-v421' : 'pandamonium-v422';
