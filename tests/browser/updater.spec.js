...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v403', 'pandamonium-v404');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v404';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v403';
  const targetCache = bridgeReload ? 'pandamonium-v403' : 'pandamonium-v404';
