...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v407', 'pandamonium-v408');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v408';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v407';
  const targetCache = bridgeReload ? 'pandamonium-v407' : 'pandamonium-v408';
