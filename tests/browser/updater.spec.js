...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v398', 'pandamonium-v399');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v399';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v398';
  const targetCache = bridgeReload ? 'pandamonium-v398' : 'pandamonium-v399';
