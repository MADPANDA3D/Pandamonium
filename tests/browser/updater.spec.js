...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v404', 'pandamonium-v405');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v405';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v404';
  const targetCache = bridgeReload ? 'pandamonium-v404' : 'pandamonium-v405';
