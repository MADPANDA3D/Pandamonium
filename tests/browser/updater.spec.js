...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v419', 'pandamonium-v420');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v420';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v419';
  const targetCache = bridgeReload ? 'pandamonium-v419' : 'pandamonium-v420';
