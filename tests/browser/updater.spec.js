...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v391', 'pandamonium-v392');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v392';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v391';
  const targetCache = bridgeReload ? 'pandamonium-v391' : 'pandamonium-v392';
