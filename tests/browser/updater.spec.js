...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v418', 'pandamonium-v419');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v419';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v418';
  const targetCache = bridgeReload ? 'pandamonium-v418' : 'pandamonium-v419';
