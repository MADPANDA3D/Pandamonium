...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v406', 'pandamonium-v407');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v407';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v406';
  const targetCache = bridgeReload ? 'pandamonium-v406' : 'pandamonium-v407';
