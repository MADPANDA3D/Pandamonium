...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v397', 'pandamonium-v398');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v398';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v397';
  const targetCache = bridgeReload ? 'pandamonium-v397' : 'pandamonium-v398';
