...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v417', 'pandamonium-v418');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v418';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v417';
  const targetCache = bridgeReload ? 'pandamonium-v417' : 'pandamonium-v418';
