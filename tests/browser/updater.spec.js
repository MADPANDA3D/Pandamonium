...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v402', 'pandamonium-v403');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v403';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v402';
  const targetCache = bridgeReload ? 'pandamonium-v402' : 'pandamonium-v403';
