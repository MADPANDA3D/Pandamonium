...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v423', 'pandamonium-v424');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v424';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v423';
  const targetCache = bridgeReload ? 'pandamonium-v423' : 'pandamonium-v424';
