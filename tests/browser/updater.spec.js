...
const FUTURE_WORKER = CURRENT_WORKER.replace('pandamonium-v405', 'pandamonium-v406');
...
for (const [scenario, bridgeReload] of [
  ...
  expect(FUTURE_WORKER).toContain("const CACHE_NAME = 'pandamonium-v406';");
  ...
  const sourceCache = bridgeReload ? 'pandamonium-v387' : 'pandamonium-v405';
  const targetCache = bridgeReload ? 'pandamonium-v405' : 'pandamonium-v406';
