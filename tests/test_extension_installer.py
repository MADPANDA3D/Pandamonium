...
def test_extension_routes_expose_preview_execute_and_readback(tmp_path, git_fixture):
    ...
    assert set(routes) == {
        ...
        "/api/extensions/installed/{extension_id}/publish",
        "/api/extensions/scans/{scan_id}/publish",
        "/api/extensions/publications/{job_id}",
        "/api/extensions/marketplace/plans",
        "/api/extensions/plans/source",
        "/api/extensions/runtime/{extension_id}/configuration",
            "/api/extensions/plans/lifecycle",
            "/api/extensions/plans/{plan_id}/execute",
            "/api/extensions/system-requirements",
