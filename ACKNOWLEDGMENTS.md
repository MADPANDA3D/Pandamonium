...
Pandamonium is an independent project derived from
...
- **[llmfit](https://github.com/AlexsJones/llmfit)** by **Alex Jones** — the
  ...
  and `scripts/pandamonium-cookbook`.
- **[Tongyi DeepResearch](https://github.com/Alibaba-NLP/DeepResearch)** by
  **Alibaba-NLP / Tongyi Lab** — the multi-step deep-research agent pipeline.
  Copyright © Alibaba-NLP / Tongyi Lab. **Apache-2.0.** Adapted for Pandamonium's
...
and run alongside Pandamonium on `docker compose up`. They are not modified —
just composed.
