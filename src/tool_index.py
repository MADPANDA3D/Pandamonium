...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "read_calendar": "Read-only Calendar access for voice and agent answers. Pulls the authenticated owner's connected CalDAV data first, then lists calendars or events. Never creates, updates, or deletes events; reports when freshness could not be confirmed.",
